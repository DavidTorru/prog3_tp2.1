...
class Reservation {
    ...
    get info() {
        return `Fecha y hora de la reserva: ${this.date.toLocaleString()}, 
        Informacion del cliente: ${this.customer.info}, 
        Numero de comensales: ${this.guests};`
    }

    static validateReservation(reservation) {
        const currentDate = new Date();
        if (reservation.date < currentDate || reservation.guests <=0) {
            return false
        }
        return true
    }
